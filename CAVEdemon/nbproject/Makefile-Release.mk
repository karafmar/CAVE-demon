...
${OBJECTDIR}/defaultDevice.o: defaultDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/defaultDevice.o defaultDevice.cpp
...
${OBJECTDIR}/eventHandler/Event.o: eventHandler/Event.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eventHandler/Event.o eventHandler/Event.cpp

${OBJECTDIR}/eventHandler/EventDevice.o: eventHandler/EventDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}/eventHandler
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eventHandler/EventDevice.o eventHandler/EventDevice.cpp

${OBJECTDIR}/eventHandler/err_codes.o: eventHandler/err_codes.cpp 
	${MKDIR} -p ${OBJECTDIR}/eventHandler
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eventHandler/err_codes.o eventHandler/err_codes.cpp
...
${OBJECTDIR}/eventMessageDataUpdate.o: eventMessageDataUpdate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eventMessageDataUpdate.o eventMessageDataUpdate.cpp

${OBJECTDIR}/eventMessageFeedback.o: eventMessageFeedback.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eventMessageFeedback.o eventMessageFeedback.cpp

${OBJECTDIR}/eventMessageNewDevice.o: eventMessageNewDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eventMessageNewDevice.o eventMessageNewDevice.cpp
...
${OBJECTDIR}/ic.o: ic.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ic.o ic.cpp

${OBJECTDIR}/icAbsAxis.o: icAbsAxis.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/icAbsAxis.o icAbsAxis.cpp

${OBJECTDIR}/icButton.o: icButton.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/icButton.o icButton.cpp

${OBJECTDIR}/icRelAxis.o: icRelAxis.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/icRelAxis.o icRelAxis.cpp
...
${OBJECTDIR}/shm/shm_common.o: shm/shm_common.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shm/shm_common.o shm/shm_common.cpp

${OBJECTDIR}/shm/trackd_common.o: shm/trackd_common.cpp 
	${MKDIR} -p ${OBJECTDIR}/shm
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/shm/trackd_common.o shm/trackd_common.cpp
...
${OBJECTDIR}/trackdModule.o: trackdModule.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trackdModule.o trackdModule.cpp
